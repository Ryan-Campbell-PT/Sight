    ...
    let post_foodList = async (saveToDb = false) => {
        ...
        try {
            await fetch("http://localhost:8080/postFoodList", {
                ...
                .then((data) => {
                    Object.assign(
                        nutritionResponse.nutritionResponseObject,
                        JSON.parse(data),
                    );
            ...
            <div id="food-list" class="my-2">
                ...
                <Label for="FoodListString">
                    ...
                    <Input
                        ...
                        bind:value={foodListString_calculate}
                    />
                </Label>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <Button onclick={() => post_foodList(true)}
                        >Visualize and Save</Button
                    >
                </div>
            </div>
            <div id="recipe-list">
